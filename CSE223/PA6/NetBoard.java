...
etc. It also handles painting the board every time a new event takes place and houses all the important information used to track the game status.
*/
...
public class NetBoard extends JPanel {
	...
	NetBox[][] boxes = new NetBox[numRows][numCols]; // the 8x8 uninitialized 2d box array
	
	// method to allow access to Dots
	public void saveDots(NetDot par) {
		parent=par;
	}
